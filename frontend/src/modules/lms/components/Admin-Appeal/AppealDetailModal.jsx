          ...
          <div className="adm-modal-content">
            ...
            <div className="adm-appeal-info">
              ...
              <div className="adm-info-row">
                ...
                <p className="adm-description-text">{appeal.description}</p>
              </div>
              <div className="adm-info-row">
            ...
            {appealType === 'bursary' && (
              <div className="adm-type-specific">
            ...
            {appealType === 'result-reeval' && (
              <div className="adm-type-specific">
                ...
                <div className="adm-info-row">
                  ...
                  <textarea
                    className="adm-process-textarea"
                    rows="3"
